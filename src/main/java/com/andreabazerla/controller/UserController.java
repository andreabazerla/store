...
import com.andreabazerla.exception.StoreException;
...
public class UserController extends ParentController
{
	...
	public ModelAndView deleteUser(HttpServletRequest request)
	{
		...
		{
			beanError.setCode(400);
			beanError.setString(e.getMessage());
	...
	public ModelAndView editUser(HttpServletRequest request)
	{
		...
		otherUser = getWebFacade().getUserService()
		                          .get(id);
		if (otherUser == null)
			throw new StoreException("Utente non trovato, ID = " + id);
	...
	public ModelAndView editAdmin(HttpServletRequest request)
	{
		...
		User_t user_t = getWebFacade().getUserService()
		                              .get(beanUser.getId());
	        ...
	        throws IOException, ServletException, SQLException
	{
		    ...
		    && (button.equals("Update") || button.equals("Manage")))
		{
			...
			if (tempUser == null || (!username.equals(beanUser.getUsername()) && (button.equals("Update"))))
			{
