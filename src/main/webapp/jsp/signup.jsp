...
<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				/* $('#region').val("<c:choose><c:when test="${action == 'EDIT_ADMIN' || action == 'EDIT_USER'}"><c:out value=''></c:out></c:when><c:otherwise><c:out value='Europe'></c:out></c:otherwise></c:choose>"); */
				/* $("input[name='sex'][value='<c:out value=''></c:out>']").prop('checked', true); */
